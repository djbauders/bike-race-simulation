...
public class Cyclist {
	...
	public static String getRacerString(Cyclist racer) {
		String str = ""; 
		str += (racer.getName() + "\nMass = " + racer.getRiderMass() +
		"\nHeight = " + racer.getRiderHeight() + "\nEDA = " + 
		racer.getEffectiveDragArea() + "\nADC = " + racer.getAirDragCoefficent() +
		"\nFTP = " + racer.getRiderFTP() + "\nRider's Style = " + racer.getRiderStyle() +
		"\nBike = " + racer.getBikeObj().getMake() + " | " + racer.getBikeObj().getModel());
		return str;
	}
